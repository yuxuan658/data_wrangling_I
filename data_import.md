...
2.  Always follow up by janitor::clean\_names(): janitor::clean\_names:
    clean up variable names after importing data. Doing so will take
    whatever the column names are and convert them to lower snake case.
...
4.  use view(datafram) function in the *console* to open the file in R
    studio.

-   “character (chr)”: the column that mix characters and numbers.
-   “double”: a particular kind of *number* in computer programming.
